...
print("Type 'Ready' to begin the challenge.")
print("For help reach out to any organiser near you , if you dont find one yell 'Help' any one of us hears you (if that was loud enough will help you)༼ つ ◕_◕ ༽つ")
while True: 
